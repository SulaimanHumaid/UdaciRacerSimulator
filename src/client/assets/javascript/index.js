...
async function handleCreateRace() {
  ...
  //   renderAt("#race", renderRaceStartView(store.tracks[track_id]));
...
async function runRace(raceID) {
  return new Promise((resolve) => {
    ...
    const interval = setInterval(async () => {
      const race = await getRace(raceID).then((res) => {
	...
	*/
  }).catch((e) => console.log(`error in runRace promise:::  ${e}`));
...
async function accelerate(id) {
  ...
  //     .catch((err) => {
  //       console.log("error in accelerate::: ");
